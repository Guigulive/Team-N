...
contract Payroll {
    ...
    //添加人员
    function AddEmployee(address employeeAddr,uint salary) onlyAdmin employeeAddressEqNull(employeeAddr){
    ...
    //领取工资 
    function getPaid(address employeeAddr) employeeAddressNotNull(employeeAddr) returns (uint) {
